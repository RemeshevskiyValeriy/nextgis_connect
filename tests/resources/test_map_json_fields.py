...
from nextgis_connect.ngw_api.qgis.qgis_ngw_connection import NgwServerFeature
...
class TestMapJsonFields(NgConnectTestCase):
    ...
    def test_upload_sets_ngw_json_datatype_for_memory_map_field(self) -> None:
        ...
        with mock.patch.object(
            ...
            "nextgis_connect.ngw_api.qgis.ngw_resource_model_4qgis.ResourceCreator.create_vector_layer",
